...
public class EntityFurnaceMonster extends EntityRaceBase implements IRangedAttackMob{
	...
	public EntityFurnaceMonster(World world){
		super(world);
	...
	public void attackEntityWithRangedAttack(EntityLivingBase target, float accuracy){
		...
		entityarrow.setDamage(2.0D + (double)((float)this.worldObj.getDifficulty().getDifficultyId() * 1.0F));
	...
	protected String getHurtSound(){
		return "arrowquest:sndFurnaceMonsterHurt";
	}
	
	@Override
	protected String getDeathSound(){
		return "arrowquest:sndFurnaceMonsterDeath"+(1+rand.nextInt(3));
	}
}
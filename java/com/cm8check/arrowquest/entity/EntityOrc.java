...
public class EntityOrc extends EntityRaceBase implements IRangedAttackMob{
	...
	public void attackEntityWithRangedAttack(EntityLivingBase target, float accuracy){
		...
		entityarrow.setDamage(2.0D + ((double) this.worldObj.getDifficulty().getDifficultyId() * 1.0D));

...
public class EntityElf extends EntityRaceBase implements IRangedAttackMob{
	...
	public void attackEntityWithRangedAttack(EntityLivingBase target, float accuracy){
		...
		entityarrow.setDamage(4.0D + (double)((float)this.worldObj.getDifficulty().getDifficultyId() * 1.0F));

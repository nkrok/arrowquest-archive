...
public class ContainerPoliceTeleporter extends Container{
	private final TileEntityPoliceTeleporter tile;
	private int destination;
	
	public ContainerPoliceTeleporter(InventoryPlayer playerInventory, TileEntityPoliceTeleporter tile){
		this.tile = tile;

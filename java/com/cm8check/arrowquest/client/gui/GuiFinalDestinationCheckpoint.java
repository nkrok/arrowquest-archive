...
public class GuiFinalDestinationCheckpoint extends GuiContainer{
	private static ResourceLocation guiTex = new ResourceLocation("arrowquest", "textures/gui/guiFinalDestinationCheckpoint.png");
	private TileEntityFinalDestinationCheckpoint tileEntity;
	
	public GuiFinalDestinationCheckpoint(InventoryPlayer inventoryPlayer, TileEntityFinalDestinationCheckpoint tile){
		super(new ContainerFinalDestinationCheckpoint(inventoryPlayer, tile));
		this.ySize = 166;
